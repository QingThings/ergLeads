...
class IndividualsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post individuals_url, params: { individual: { comments: @individual.comments, email: @individual.email, first_name: @individual.first_name, job_title: @individual.job_title, last_name: @individual.last_name, phone: @individual.phone } }
    end
  ...
  test "should update individual" do
    patch individual_url(@individual), params: { individual: { comments: @individual.comments, email: @individual.email, first_name: @individual.first_name, job_title: @individual.job_title, last_name: @individual.last_name, phone: @individual.phone } }
